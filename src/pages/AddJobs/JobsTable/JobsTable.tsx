...
export function JobsTable(props: JobsState) {
    ...
    const { jobToDelete, columns, handleDelete, onCancelDelete } = useJobsTable(props);
    ...
    return (
        <styled.TableWrapper>
            ...
            {jobToDelete && <DeleteModal nameDeleting={jobToDelete.name} onConfirm={handleDelete} onCancel={onCancelDelete} />}
        </styled.TableWrapper>
    );
}
